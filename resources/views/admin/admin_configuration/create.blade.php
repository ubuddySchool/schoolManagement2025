                                    ...
                                    <div class="row" style="margin-top: 40px; padding: 0 10px;">
                                        ...
                                        <div class="col-lg-3 col-md-3">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" name="configAdminName" type="text"
                                        ...
                                        <div class="col-lg-3 col-md-3">
                                            <div class="form-group local-forms calendar-icon">
                                                ...
                                                <input class="form-control datetimepicker" type="text"
                                                    placeholder="DD-MM-YYYY" name="configAdminDOB">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-3">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" name="configAdminImage"
                                        ...
                                        <div class="col-lg-3 col-md-3">
                                            <div class="form-group local-forms">
                                                <label>Contact Number <span
                                                        class="login-danger">*</span></label>
                                                <input class="form-control" name="configAdminNumber" type="text"
                                                    placeholder="Enter Number" maxlength="10" pattern="\d{10}"
                                                    title="Enter Number" required
                                        ...
                                        <div class="col-lg-3 col-md-3">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" name="configAdminAlternateNUmber"
                                        ...
                                        <div class="col-lg-3 col-md-3">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" name="configAdminEmail" type="email"
                                        ...
                                        <div class="col-lg-3 col-md-3">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" name="configAdminPassword"
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group local-forms">
                                                <label>Remarks</label>
                                                <input class="form-control" name="configAdminRemark"
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="student-submit" style="display: flex;justify-content: center;">
                                                <button type="submit" class="btn btn-primary" name="submit_details"
