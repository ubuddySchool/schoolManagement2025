...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-auto text-end float-end ms-auto download-grp">
                    ...
                    <a data-bs-toggle="modal" data-bs-target="#export-alert-modal" class="btn btn-primary me-2"
                        title="Export file"><i class="fa-solid fa-file-export"></i></a>
                    <!--<a data-bs-toggle="modal" data-bs-target="#layout4result" class="btn btn-primary me-2">New Result</a>-->

                    <a href="{{ route('student.result.lock') }}" class="btn btn-primary me-2">Lock Result</a>

                    <a href="{{ route('student.result.division') }}" class="btn btn-primary me-2">Add Division</a>

                    <a data-bs-toggle="modal" data-bs-target="#con-view-layout" class="btn btn-primary me-2">Result
                        Layout</a>
                ...
                <div class="card comman-shadow">
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-2 col-md-2">
                                <select name="currentClass" class="currclass dropdown-select" id="selectclassacad"
                                    data-school="20">
                            ...
                            <div class="col-lg-2 col-md-2">
                                <select class="currclass dropdown-select" name="resultType" id="resultType">
                                    ...
                                    <option>
                                        <a data-bs-toggle="modal" data-bs-target="#export-alert-modal"
                                            class="btn btn-primary me-2" title="Export file">Cross Wise</a>
                                    </option>
        ...
        <div id="con-view-layout" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                    ...
                    <form action="" method="post">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-info waves-effect waves-light"
                                name="layoutUpdate">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div id="view-layouts-edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="" method="post">
                        ...
                        <div class="modal-body p-4">
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Akash Singh</td>
                                        <td><input type="number" class="form-control marks" placeholder="Enter Marks">
                                        </td>
                                        <td><input type="number" class="form-control marks" placeholder="Enter Marks">
                                        </td>
                                        <td>
        ...
        <div id="layout4result" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
        ...
        <div id="export-alert-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="export_stuDetails.php" method="post" target="_blank">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <input type="text" hidden class="form-control" value="testschool" name="usernamePost"
                                    required>
                            </div>
                                ...
                                <div class="row" style="margin-bottom: 0.5rem;">
                                    <div class="col-md-12">
                                        <div class="form-check align-items-center">
                                            <input type="checkbox" class="form-check-input" id="parentSign"
                                                name="parentSign" value="1">
                        ...
                        <div class="modal-footer">
                            <a href="{{ route('student.result.empty') }}" name="blankFileExport"
                                class="btn btn-primary">Export Blank File</a>
                            <a href="{{ route('student.result.filled') }}" name="filledFileExport"
                                class="btn btn-primary">Export Filled File</a>
