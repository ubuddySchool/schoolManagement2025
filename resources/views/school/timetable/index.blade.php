...
<div id="change-term-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" id="printContent">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Terms Select</h4>
            ...
            <div class="modal-footer">
                ...
                <a href="{{ route('school_student.timetable') }}" class="btn btn-sm btn-primary" id="proceedBtn">Submit</a>
            </div>
        </div>
    </div>
</div>
