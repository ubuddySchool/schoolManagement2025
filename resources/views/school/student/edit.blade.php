                        ...
                        <form method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="row" style="margin-top: 40px; padding: 0 10px;">
                                            ...
                                            <div class="col-12 col-sm-3">
                                                <div class="form-group local-forms calendar-icon">
                                                    ...
                                                    <input class="form-control datetimepicker" type="text" value=""
                                                        placeholder="DD-MM-YYYY" name="admissionDate">
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-3">
                                                <div class="form-group local-forms">
                                                    <label>Scholar/Admission Number<span
                                                            class="login-danger">*</span></label>
                                                    <input class="form-control" type="text" name="scholarNumber"
                                                        value="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-3">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <!--</select>-->
                                                    <input class="form-control" type="text" name="admissionClass"
                                                        value="" hidden>
                                                    <input class="form-control" type="text" name="admissionClass1"
                                                        value="" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-3">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input class="form-control" type="text" name="tcDetails"
                                                        value="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-3">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input class="form-control" type="text" name="PreviousClass"
                                                        value="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-3">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input class="form-control" type="text" name="PreviousSchool"
                                                        value="">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="margin-top: 40px; padding: 0 10px;">
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input class="form-control" name="studentReligion" type="text"
                                                        value="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input class="form-control" name="studentNationality" type="text"
                                                        value="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    <label>Student Image<span class="login-danger">*</span></label>
                                                    <input class="form-control" name="studentImage"
                                                        id="studentImageInput" type="file" accept="image/*">
                                                    <p id="imageFileName" style="margin-top:5px;display:none;"></p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <img src="{{ asset('assets/img/default.png') }}" width="100"
                                                        height="100">
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <select name="studentMtype" id="options1"
                                                        style=" border: 1px solid #ddd; box-shadow: none; color: #333; font-size: 15px; height: 45px; border-radius: .25rem;;width:100%;padding: .375rem .75rem;">
                                                        <option value=""></option>
                                            ...
                                            <div class="col-12 col-sm-4" id="input-field1" style="display:none;">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input class="form-control" name="studentMProblem" type="text"
                                                        value="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input class="form-control" type="text" name="studentMtongue"
                                                        value="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input class="form-control" name="AadharNumber" type="text"
                                                        value="" oninput="formatAadharNumber(event)"
                                                        maxlength="14">
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input class="form-control" type="text" name="studentSamagra"
                                                        value="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input class="form-control" type="text"
                                                        name="studentFamilySamagra" value="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input class="form-control" type="text" name="studentBirthMark"
                                                        value="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <select name="studentSpeciallytype" id="options"
                                                        style=" border: 1px solid #ddd; box-shadow: none; color: #333; font-size: 15px; height: 45px; border-radius: .25rem;;width:100%;     padding: .375rem .75rem;">
                                                        <option value=""></option>
                                                        <option value="Yes">Yes</option>
                                                        <option value="No">No</option>
                                            ...
                                            <div class="col-12 col-sm-4" id="input-field" style="display:none;">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input class="form-control" name="studentSpeciallyAble"
                                                        type="text" value="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input class="form-control" id="inputField1"
                                                        name="studentPrimaryNumber" type="text" value=""
                                                        maxlength="10">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input class="form-control" name="studentWhatsappNumber"
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    <label>Relation to the person<span
                                                            class="login-danger">*</span></label>
                                                    <input class="form-control" name="studentRelation" type="text"
                                                        value="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input class="form-control" name="studentSiblingName" type="text"
                                                        value="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <select name="studentSiblingScholtype" id="options2"
                                                        style=" border: 1px solid #ddd; box-shadow: none; color: #333; font-size: 15px; height: 45px; border-radius: .25rem;;width:100%; padding: .375rem .75rem;">
                                                        <option value=""></option>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input class="form-control" name="studentCaste" type="text"
                                                        value="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    <label>Permanent Education Number<span
                                                            class="login-danger">*</span></label>
                                                    <input class="form-control" name="studentPENno" type="text"
                                                        value="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    <label>Economically Weaker Section <span
                                                            class="login-danger">*</span></label>
                                                    <select name="ews"
                                                        style=" border: 1px solid #ddd; box-shadow: none; color: #333; font-size: 15px; height: 45px; border-radius: .25rem;;width:100%;padding: .375rem .75rem;">
                                                        <option value=""></option>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input class="form-control" name="studentAppartNumber" type="text"
                                                        placeholder="Enter APAAR ID" value="" maxlength="12"
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-6" style="margin-top: 2.5rem;">
                                                    <div class="form-group local-forms" style="border: 1px solid #f2f2f2">
                                                        <label style=" font-size: 18px;">Current Address<span
                                                                class="login-danger">*</span></label>
                                                        <div class="row" style="margin-top: 40px;padding: 0 10px;">
                                                ...
                                                <div class="col-12 col-sm-6">
                                                            ...
                                                            <div class="form-group local-forms" style="margin-bottom: 0;">
                                                                <p> <input type="checkbox" id="copyAddress">
                                                                    <label for="copyAddress"
                                                                        style="top: 0;left: 15px;">Please Checked, If both
                                                                        are same.</label>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group local-forms" style="border: 1px solid #f2f2f2">
                                                        <label style=" font-size: 18px;">Permanent Address<span
                                                                class="login-danger">*</span></label>
                                                        <div class="row" style="margin-top: 40px; padding: 0 10px;">
                                                            <div class="col-12 col-sm-6">
                                                                <div class="form-group local-forms">
                                                ...
                                                <div class="row" style="margin-top: 40px; padding: 0 10px;">
                                                    <div class="col-12 col-sm-3">
                                                        <div class="form-group local-forms">
                                                            ...
                                                            <input class="form-control" name="studentBankName"
                                                                type="text" value="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12 col-sm-3">
                                                        <div class="form-group local-forms">
                                                            ...
                                                            <input class="form-control" name="studentIFSC" type="text"
                                                                value="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12 col-sm-3">
                                                        <div class="form-group local-forms">
                                                            <label>Account Number<span
                                                                    class="login-danger">*</span></label>
                                                            <input class="form-control" name="studentAccountNo"
                                                                type="text" value="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12 col-sm-3">
                                                        <div class="form-group local-forms">
                                                            <label>Account Holder Name<span
                                                                    class="login-danger">*</span></label>
                                                            <input class="form-control" name="studentAccountHolderName"
                                                                type="text" value="">
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="row" style="margin-top: 40px;padding: 0 10px;">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <select name="currentClass" id="selectclassacad" data-school=" 20"
                                                    style=" border: 1px solid #ddd; box-shadow: none; color: #333; font-size: 15px; height: 45px; border-radius: .25rem;;width:100%; padding: .375rem .75rem;">
                                                    <option value="">Select Class</option>
                                                    <option value="86" data-classcat="A">Nursery</option>
                                                    <option value="88" data-classcat="A">UKG</option>
                                        ...
                                        <div class="col-12 col-sm-4" id="input-section1" style="">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" type="text" name="Section" value=""
                                                    hidden>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" name="RollNumber" type="text"
                                                    value="">
                                            </div>
                                        </div>
                                ...
                                <div class="form-group local-forms" style="border: 1px solid #f2f2f2">
                                    ...
                                    <div class="row" style="margin-top: 40px;padding: 0 10px;">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Aadhar Number <span class="login-danger">*</span></label>
                                                <input class="form-control" name="FatherAadharNumber" type="text"
                                                    value="" oninput="formatAadharNumber(event)" maxlength="14">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" name="FatherQualification" type="text"
                                                    value="">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" name="FatherOfcAddress" type="text"
                                                    value="">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" name="FatherIncome" type="text"
                                                    value="">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Nationality<span class="login-danger">*</span></label>
                                                <input class="form-control" name="FatherNationality" type="text"
                                                    value="">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <select name="fatherSP" id="options2"
                                                    style=" border: 1px solid #ddd; box-shadow: none; color: #333; font-size: 15px; height: 45px; border-radius: .25rem;;width:100%; padding: .375rem .75rem;">
                                                    <option value=""></option>
                                                    <option value="Yes">Yes</option>
                                                    <option value="No ">No</option>
                                ...
                                <div class="form-group local-forms" style="border: 1px solid #f2f2f2">
                                    ...
                                    <div class="row" style="margin-top: 40px;padding: 0 10px;">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Contact Number<span class="login-danger">*</span></label>
                                                <input class="form-control" name="MotherNumber" id="inputField4"
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Aadhar Number <span class="login-danger">*</span></label>
                                                <input class="form-control" name="MotherAadharNumber" type="text"
                                                    value="" oninput="formatAadharNumber(event)" maxlength="14">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Qualification <span class="login-danger">*</span></label>
                                                <input class="form-control" name="MotherQualification" type="text"
                                                    value="">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <select name="MotherOccupation" id="options2"
                                                    style=" border: 1px solid #ddd; box-shadow: none; color: #333; font-size: 15px; height: 45px; border-radius: .25rem;;width:100%; padding: .375rem .75rem;">
                                                    <option value=""></option>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Office Address<span class="login-danger">*</span></label>
                                                <input class="form-control" name="MotherOfcAddress" type="text"
                                                    value="">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Annual Income <span class="login-danger">*</span></label>
                                                <input class="form-control" name="MotherIncome" type="text"
                                                    value="">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Nationality<span class="login-danger">*</span></label>
                                                <input class="form-control" name="MotherNationality" type="text"
                                                    value="">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Single Parent<span class="login-danger"> *</span></label>
                                                <select name="MotherSP" id="options2"
                                                    style=" border: 1px solid #ddd; box-shadow: none; color: #333; font-size: 15px; height: 45px; border-radius: .25rem;;width:100%; padding: .375rem .75rem;">
                                                    <option value=""></option>
                                                    <option value="Yes">Yes</option>
                                                    <option value="No ">No</option>
                                ...
                                <div class="form-group local-forms" style="border: 1px solid #f2f2f2">
                                    ...
                                    <div class="row" style="margin-top: 40px;padding: 0 10px;">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Contact Number<span class="login-danger">*</span></label>
                                                <input class="form-control" name="GuardianNumber" id="inputField5"
                                                    type="text" placeholder="Enter Number" value=""
                                                    oninput="formatContactNumber(event)" maxlength="12">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Aadhar Number <span class="login-danger">*</span></label>
                                                <input class="form-control" name="GuardianAadharNumber" type="text"
                                                    value="" oninput="formatAadharNumber(event)" maxlength="14">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Qualification <span class="login-danger">*</span></label>
                                                <input class="form-control" name="GuardianQualification" type="text"
                                                    value="">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Occupation<span class="login-danger"> *</span></label>
                                                <select name="GuardianOccupation" id="options2"
                                                    style=" border: 1px solid #ddd; box-shadow: none; color: #333; font-size: 15px; height: 45px; border-radius: .25rem;;width:100%; padding: .375rem .75rem;">
                                                    <option value=""></option>
                                                    <option value="Salaried">Salaried</option>
                                                    <option value="Self Employed ">Self Employed </option>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Office Address<span class="login-danger">*</span></label>
                                                <input class="form-control" name="GuardianOfcAddress" type="text"
                                                    value="">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Annual Income <span class="login-danger">*</span></label>
                                                <input class="form-control" name="GuardianIncome" type="text"
                                                    value="">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Nationality<span class="login-danger">*</span> </label>
                                                <input class="form-control" name="GuardianNationality" type="text"
                                                    value="">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Single Parent<span class="login-danger"> *</span></label>
                                                <select name="GuardianSP" id="options2"
                                                    style=" border: 1px solid #ddd; box-shadow: none; color: #333; font-size: 15px; height: 45px; border-radius: .25rem;;width:100%; padding: .375rem .75rem;">
                                                    <option value=""></option>
                                                    <option value="Yes">Yes</option>
                                                    <option value="No ">No</option>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Bank Account Passbook<span class="login-danger">*</span></label>
                                                <input class="form-control" name="GuardianAccountImage"
                                                    type="file">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                            ...
                            <div class="col-12">
                                <div class="student-submit" style="display: flex;justify-content: center;">
                                    <button type="submit" class="btn btn-primary" name="updatestudentinfo"
                                        style="font-size:1.7rem;min-width:350px;">Submit</button>
                                </div>
                            </div>
                    </div>
                    </form>
