                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="profile-user-box">
                                    <div class="profile-user-img">
                                        <img src="{{ asset('assets/img/default.png') }}" alt="Profile student_images/" width="100" height="140">
            ...
            <h4>Raj Maheshwari</h4>
                ...
                <div class="row" style="padding-bottom: 80px;">
                    ...
                    <div class="col-sm-4" style="padding: 10px; 0">
                        <a href="student_images/1685745348Untitled-1.png" data-lightbox="event-gallery" data-title="1685745348Untitled-1.png">
